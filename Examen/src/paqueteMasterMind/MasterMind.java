...
pedirJugada (i);
	...
	private boolean visualizarSalida(boolean acertada, int i, String texto) {
		System.out.println ();
		if (acertada) {
	...
	private long modificarHeridos(int numRM, int numVM, int numAM, int numBM, int numNM, int numMM, int numGM, int numSM,
			...
			int numMJugada, int numGJugada, int numSJugada, long heridos, String texto) {
